  ...
  return (
    <Paper elevation={3}>
      ...
      >
        ...
        <BottomNavigationAction value="rooms" label="Stats" icon={<i className="fa-solid fa-list"></i>} disabled />
        <BottomNavigationAction value="profile" label="Profile" icon={<i className="fa-solid fa-arrow-right"></i>} disabled />
        <BottomNavigationAction value="settings" label="Settings" icon={<i className="fa-solid fa-gear"></i>} disabled />
      </BottomNavigation>
    </Paper>
  );
}
